...
Security Definition message for LME Order Entry Gateway.

## Message Specification

### FIX Protocol Details
- **Message Type:** `d`
- **Message Name:** Security Definition
...
### Success Scenario
```
Client → Gateway: Security Definition (d)
...
### Example: Security Definition (d)

```csv
# Message: Security Definition (d)
# Direction: Client→Gateway
