...
Sequence Reset message for LME Order Entry Gateway.

## Message Specification

### FIX Protocol Details
- **Message Type:** `4`
- **Message Name:** Sequence Reset
...
### Success Scenario
```
Client → Gateway: Sequence Reset (4)
...
| 35 | MsgType | String | Message type = 4 |
